...
/**
    ...
    @param <T>
 */
public class ElementoTableModel<T> extends AbstractTableModel {
    ...
    public ElementoTableModel(Class<T> CLASS_TYPE, ArrayListObservable<T> dataSource, Tabela tabela) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        try {
            ...
            System.getLogger(ElementoTableModel.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        }finally{
            field.setAccessible(true);                    
        }
